...
/**
 * Middleware that checks if a user has the required permission level for a dashboard
 * Admins bypass all checks, editors can view all dashboards, viewers need explicit permissions
 */
